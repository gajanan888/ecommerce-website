      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 md:py-32">
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="col-span-2 lg:col-span-5">
            <Link
              to="/"
              className="inline-flex items-center gap-3 text-3xl font-black text-white tracking-tighter uppercase mb-8"
            >
            ...
            <p className="max-w-sm text-sm leading-relaxed mb-12 uppercase tracking-widest font-bold text-white/20">
              Curated architectural silhouettes for the modern individual. We
              define style as a medium of empowerment and sustainable
              expression.
            </p>
            <div className="flex gap-3">
              {[FiInstagram, FiTwitter, FiFacebook, FiLinkedin].map(
                (Icon, i) => (
                  <button
                    key={i}
                    className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:bg-white hover:text-black transition-all duration-700"
                  >
                    <Icon size={20} />
                  </button>
                )
          ...
          <div className="col-span-1 lg:col-span-2">
            <h4 className="text-[10px] font-black text-orange-500 uppercase tracking-[0.4em] mb-8">
              Collections
            </h4>
